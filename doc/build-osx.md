...
1. Clone the DOMO Core source code:

        git clone https://github.com/domo-project/domo
        cd domo
...
DOMO Core is now available at `./src/domod`

Before running, you may create an empty configuration file:

    mkdir -p "/Users/${USER}/Library/Application Support/DOMO"

    touch "/Users/${USER}/Library/Application Support/DOMO/domo.conf"

    chmod 600 "/Users/${USER}/Library/Application Support/DOMO/domo.conf"

The first time you run domod, it will start downloading the blockchain. This process could take many hours, or even days on slower than average systems.
...
-------
    ...
    ./src/domod -daemon # Starts the domo daemon.
    ./src/domo-cli --help # Outputs a list of command-line options.
    ./src/domo-cli help # Outputs a list of RPC commands when the daemon is running.
