...
from fake_stake.base_test import DOMO_FakeStakeTest

class zDOMwrappedSerialsTest(DOMO_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zDOMs..." % DENOM_TO_USE)
