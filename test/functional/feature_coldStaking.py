...
from test_framework.domo_node import DomoTestNode
...
class DOMO_ColdStakingTest(BitcoinTestFramework):
    ...
    def init_test(self):
        ...
        for i in range(self.num_nodes):
            self.test_nodes.append(DomoTestNode())
