...
//
// The Masternode Class. For managing the Obfuscation process. It contains the input of the 1000 DOM, signature to prove
...
public:
    ...
    /// Is the input associated with collateral public key? (and there is 1000 DOM - checking if valid masternode)
