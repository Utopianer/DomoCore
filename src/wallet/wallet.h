...
enum AvailableCoinsType {
    ...
    ONLY_DENOMINATED = 2,
    ONLY_NOT10000IFMN = 3,
    ONLY_NONDENOMINATED_NOT10000IFMN = 4, // ONLY_NONDENOMINATED and not 1000 DOM at the same time
...
public:
    ...
    */
    ...
    /// Get 1000 DOM output and keys which can be used for the Masternode
