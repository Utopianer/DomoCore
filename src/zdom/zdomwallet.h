...
#ifndef DOMO_ZDOMWALLET_H
#define DOMO_ZDOMWALLET_H
...
public:
    CzDOMWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZDOM(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZDOM(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
