...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        {"zerocoin", "getzdomseed", &getzdomseed, false, false, true},
        {"zerocoin", "setzdomseed", &setzdomseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzdom", &searchdzdom, false, false, true},
        {"zerocoin", "dzdomstate", &dzdomstate, false, false, true},
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:30718/\n";
}
