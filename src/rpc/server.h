...
extern UniValue DoZdomSpend(const CAmount nAmount, bool fMintChange, bool fMinimizeChange, std::vector<CZerocoinMint>& vMintsSelected, std::string address_str, bool isPublicSpend = true);
...
extern UniValue setzdomseed(const UniValue& params, bool fHelp);
extern UniValue getzdomseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzdom(const UniValue& params, bool fHelp);
extern UniValue dzdomstate(const UniValue& params, bool fHelp);
