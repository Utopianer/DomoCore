...
#include "qt/domo/welcomecontentwidget.h"
#include "qt/domo/forms/ui_welcomecontentwidget.h"
#include <QFile>
#include <QListView>
#include <QDir>
#include "guiutil.h"
    ...
    nextButton(new QPushButton())
{
    ...
    backButton->setStyleSheet("background: url(://ic-arrow-white-left); background-repeat:no-repeat;background-position:center;border:  0;background-color:#be7732;color: #be7732; border-radius:2px;");
    nextButton->move(nextX, nextY);
    nextButton->setStyleSheet("background: url(://ic-arrow-white-right);background-repeat:no-repeat;background-position:center;border:  0;background-color:#be7732;color: #be7732; border-radius:2px;");
