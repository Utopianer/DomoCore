...
#include "qt/domo/forms/ui_masternodewizarddialog.h"
    ...
    walletModel(model)
{
    ...
    ui->lineEditPort->setPlaceholderText("e.g 30717");
    ...
    if(walletModel->isTestnet()){
        ...
        ui->lineEditPort->setText("30719");
    } else {
        ui->lineEditPort->setText("30717");
    }
