...
#include "qt/domo/settings/forms/ui_settingsmultisendwidget.h"
#include "qt/domo/settings/settingsmultisenddialog.h"
    ...
    ui(new Ui::SettingsMultisendWidget)
{
    ...
    ui->labelSubtitle1->setText(tr("MultiSend allows you to automatically send up to 100% of your stake or masternode reward to a list of other DOMO addresses after it matures."));
