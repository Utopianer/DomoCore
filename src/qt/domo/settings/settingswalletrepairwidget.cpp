...
#include "qt/domo/settings/forms/ui_settingswalletrepairwidget.h"
...
SettingsWalletRepairWidget::SettingsWalletRepairWidget(DOMOGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to DOMOGUI::handleRestart()
