...
#include "qt/domo/settings/forms/ui_settingsbittoolwidget.h"
...
SettingsBitToolWidget::SettingsBitToolWidget(DOMOGUI* _window, QWidget *parent) :
    ...
    ui(new Ui::SettingsBitToolWidget)
{
    ...
    // Address
    ui->labelSubtitleAddress->setText(tr("Enter a DOMO address"));
...
void SettingsBitToolWidget::importAddressFromDecKey(){
    ...
    ui->statusLabel_DEC->setText(tr("Successfully added domate key to the wallet"));
}
