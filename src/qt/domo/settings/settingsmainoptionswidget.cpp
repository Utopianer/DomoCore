...
#include "qt/domo/settings/forms/ui_settingsmainoptionswidget.h"
#include "QListView"
...
SettingsMainOptionsWidget::SettingsMainOptionsWidget(DOMOGUI* _window, QWidget *parent) :
    ...
    ui(new Ui::SettingsMainOptionsWidget)
{
    ...
    // Switch
    ui->pushSwitchStart->setText(tr("Start DOMO on system login"));
