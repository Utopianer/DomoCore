...
#include "qt/domo/settings/settingsnetworkwidget.h"
#include "qt/domo/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/domo/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(DOMOGUI* _window, QWidget *parent) :
