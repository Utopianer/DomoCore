...
#include "qt/domo/forms/ui_masternodeswidget.h"
#include "qt/domo/qtutils.h"
#include "qt/domo/mnrow.h"
#include "qt/domo/mninfodialog.h"

#include "qt/domo/masternodewizarddialog.h"
...
MasterNodesWidget::MasterNodesWidget(DOMOGUI *parent) :
    PWidget(parent),
    ...
    if (boost::filesystem::exists(pathBootstrap)) {
        ...
        if (lineCopy.size() == 0) {
            lineCopy = "# Masternode config file\n"
                                    ...
                                    "# Example: mn1 127.0.0.2:30717 93HaYBVUCYjEMeeH1Y4sBGLALQZE1Yc1K64xiqgX37tGBDQL8Xg 2bcd3c84c84f87eaa86e4e56834c92927a07f9e18718810b92e0d0324456a67c 0\n";
        }
...
void MasterNodesWidget::onCreateMNClicked(){
    if(verifyWalletUnlocked()) {
        if(walletModel->getBalance() <= Params().MasternodeCollateral()){
            inform(tr("Not enough balance to create a masternode, 1,000 DOM required."));
            return;
        }
        showHideOp(true);
