...
bool openDialogWithOpaqueBackgroundY(QDialog *widget, DOMOGUI *gui, double posX = 3, int posY = 5);
bool openDialogWithOpaqueBackground(QDialog *widget, DOMOGUI *gui, double posX = 3);
