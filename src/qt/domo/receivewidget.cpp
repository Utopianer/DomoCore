...
#include "qt/domo/forms/ui_receivewidget.h"
...
ReceiveWidget::ReceiveWidget(DOMOGUI* parent) :
    PWidget(parent),
    ui(new Ui::ReceiveWidget)
{
    ...
    ui->labelSubtitle1->setText(tr("Scan the QR code or copy the address to receive DOM."));
