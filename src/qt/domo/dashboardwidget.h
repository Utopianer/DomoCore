...
#include "qt/domo/furabstractlistitemdelegate.h"
...
#include "config/domo-config.h" /* for USE_QTCHARTS */
#endif
...
public:
    ...
    qint64 totalDom = 0;
    qint64 totalZdom = 0;
    QList<qreal> valuesDom;
    QList<qreal> valueszDom;
    QStringList xLabels;
};
...
public:
    explicit DashboardWidget(DOMOGUI* _window);
    ~DashboardWidget();
