...
#ifndef DOMO_CORE_NEW_GUI_DOMOGUI_H
#define DOMO_CORE_NEW_GUI_DOMOGUI_H
...
#include "qt/domo/navmenuwidget.h"
#include "qt/domo/topbar.h"
#include "qt/domo/dashboardwidget.h"
#include "qt/domo/send.h"
#include "qt/domo/receivewidget.h"
#include "qt/domo/addresseswidget.h"
#include "qt/domo/privacywidget.h"
#include "qt/domo/masternodeswidget.h"
#include "qt/domo/snackbar.h"
...
/**
  DOMO GUI main class. This class represents the main window of the DOMO UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class DOMOGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit DOMOGUI(const NetworkStyle* networkStyle, QWidget* parent = 0);
    ~DOMOGUI();
...
#endif //DOMO_CORE_NEW_GUI_DOMOGUI_H
