...
#include "qt/domo/contactsdropdown.h"
#include "qt/domo/sendmultirow.h"
#include "qt/domo/sendcustomfeedialog.h"
...
public:
    explicit SendWidget(DOMOGUI* parent);
    ~SendWidget();
...
private slots:
    void onDOMSelected(bool _isDOM);
    void onSendClicked();
...
private:
    ...
    bool sendZdom(QList<SendCoinsRecipient> recipients);
