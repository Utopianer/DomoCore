...
#include "qt/domo/coincontroldomwidget.h"
#include "qt/domo/forms/ui_coincontroldomwidget.h"

CoinControlDomWidget::CoinControlDomWidget(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::CoinControlDomWidget)
{
    ui->setupUi(this);
    ...
    ui->labelTitle->setText("Select DOM Outputs to Spend");
    ...
    ui->labelTitleAmount->setText("DOM");
    ...
    ui->labelValueAfter->setText("0.00 DOM");
    ui->labelValueAmount->setText("0");
    ui->labelValueBytes->setText("0");
    ui->labelValueDust->setText("No");
    ui->labelValueChange->setText("0.00 DOM");
    ui->labelValueFee->setText("0.00 DOM");
...
CoinControlDomWidget::~CoinControlDomWidget()
{
    delete ui;
}
