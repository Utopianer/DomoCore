...
// Copyright (c) 2015-2018 The DOMO developers
...
#include "qt/domo/loadingdialog.h"
...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        bool ret = openStandardDialog(
                ...
                tr("Warning: If you encrypt your wallet and lose your passphrase, you will <b>LOSE ALL OF YOUR DOM</b>!") + "<br><br>" + tr("Are you sure you wish to encrypt your wallet?"),
                tr("ENCRYPT"), tr("CANCEL")
        );
        if (ret) {
            if (newpass1 == newpass2) {
                newpassCache = newpass1;
                DOMOGUI* window = static_cast<DOMOGUI*>(parentWidget());
...
bool AskPassphraseDialog::openStandardDialog(QString title, QString body, QString okBtn, QString cancelBtn){
    DOMOGUI* gui = static_cast<DOMOGUI*>(parentWidget());
...
void AskPassphraseDialog::warningMessage() {
    hide();
    static_cast<DOMOGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("DOMO will close now to finish the encryption process. "
               "Remember that encrypting your wallet cannot fully protect "
               "your DOMs from being stolen by malware infecting your computer.") +
            "<br><br><b>" +
