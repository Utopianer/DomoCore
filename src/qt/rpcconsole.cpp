                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzDOMPathCustom = GetArg("-zdombackuppath", "");
    ...
    if(!strzDOMPathCustom.empty()) {
        ui->wallet_customzdombackuppath->setText(QString::fromStdString(strzDOMPathCustom));
        ui->wallet_customzdombackuppath_label->setVisible(true);
        ui->wallet_customzdombackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzDOMPathCustom.empty()) && nCustomBackupThreshold > 0) {
