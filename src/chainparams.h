...
public:
    ...
    int DomoBadBlockTime() const { return nDomoBadBlockTime; }
    int DomoBadBlocknBits() const { return nDomoBadBlocknBits; }
...
protected:
    ...
    int nLastPOWBlock;
    int64_t nDomoBadBlockTime;
    unsigned int nDomoBadBlocknBits;
